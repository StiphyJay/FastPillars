...
@PIPELINES.register_module
class AssignLabel_fastpillar(object):
    def __init__(self, **kwargs):
        """Return CenterNet training labels like heatmap, height, offset"""
        assigner_cfg = kwargs["cfg"]
        # self.out_size_factor = assigner_cfg.out_size_factor
    ...
    def __call__(self, res, info):
        ...
        if res["mode"] == "train":
            ...
            # feature_map_size = grid_size[:2] // self.out_size_factor
            gt_dict = res["lidar"]["annotations"] #["gt_boxes"] N*9  x, y, z gt_dict['gt_boxes'][id][0]->[2] w, l, h->gt_dict['gt_boxes'][id][3]->[5]
            #vx, vy = gt_dict['gt_boxes'][id][6:8] rot = gt_dict['gt_boxes'][id][8]
            ...
            gt_dict["gt_classes"] = task_classes
            gt_dict["gt_names"] = task_names
            gt_dict["gt_boxes"] = task_boxes #逐个类别的真值边框
            ...
            for idx, task in enumerate(self.tasks):
                ...
                # print('cur_feat_map_size',cur_feat_map_size)
                # import pdb; pdb.set_trace()
                ...
                for k in range(num_objs):
                    ...
                    if w > 0 and l > 0:
                        ...
                        mask[new_idx] = 1
                        gt_box[new_idx] = gt_dict['gt_boxes'][idx][k][[0, 1, 2, 3, 4, 5, 8]] #xyz,wlh,rot
